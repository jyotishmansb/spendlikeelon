export const speechData = {
    ...
    welcome: [
      ...
      "Time to disrupt the shopping industry! To the moon! 🚀",
    ...
    low: [
      ...
      "This wouldn’t buy Starship fuel for 1 second!",
      ...
      "That wouldn’t buy a single rocket screw",
      "it costs Less than 1 second of Starlink revenue",
      "My X Æ A-XII’s toy rocket costs more",
      "That’s like… negative money in billionaire math",
      "That’s smaller than my lunch tip at SpaceX"
    ],
    ...
    medium: [
      ...
      "Not bad. That’s like one SpaceX pizza party",
      "Not bad! That's what I tip my rocket scientists!",
      "That’s about one minute of Starship fuel burn!",
      "For that price, it better be 420% efficient!",
      "That’s what I pay in WiFi fees on a private jet",
      "That’s basically my engineers snack budget",
    ...
    superHigh:[
      ...
      "Flex much? Someone’s got expensive taste!",
      "Ka-ching! That price tag screams 'YOLO!'",
      "This isn’t shopping, this is GDP manipulation",
      ...
      "You’re burning cash faster than a Raptor engine burns methane",
      "Even Mars real estate is cheaper",
      "At this point, you’re basically funding a new startup",
      "At this level, it’s not shopping — it’s empire-building",
      "You just bought something the UN would debate about",
      "Even Mars is looking affordable compared to that"

    ],
     ultraHigh : [
      "That’s not an item, that’s GDP manipulation!",
      "Congrats! You’ve officially unlocked 'Millionaire Madness' mode!",
      "Whoa! You just made Jeff Bezos jealous.",
      "That purchase just broke the game’s economy... are you proud?",
      "That’s more than most VC seed rounds",
      "You’re one purchase away from needing a financial advisor.",
      "You just made Jeff Bezos nervous",
      "That’s more than the budget for half the startups in Silicon Valley",
      "Big spender level: MAXED OUT. Are you buying the moon next?",
      "When you spend that much, the item should come with a butler.",
      "That’s not shopping — that’s acquiring nations",
      "You just spent a NASA mission budget",
      "This is UN-debate level money",
      "That’s GDP-sized shopping",
  ...
  ,
    ...
    excited: [
      "This shopping spree is lit! 🔥 Literally, like our rockets!",
    ...
    easterEgg: [
      "X Æ A-XII would love this purchase!",
    ...
    //     "Today’s mission: make my bank account cry!",
    //     "My credit card says swipe faster—I must obey!",
    //     "Money can't buy happiness, but spending it feels pretty close!",
    //     "Saving money? Sorry, that's not my style!",
    //     "My accountant’s nightmare is my favorite dream!",
    //     "Help! My wallet’s overflowing, and it’s your job to empty it!",
    //     "If spending were an Olympic sport, I'd be a gold medalist!",
    //     "My savings ran away. Let’s spend before they come back!",
    //     "Time to turn dollars into memories—preferably silly ones!",
